...
@MainActor
class ResourceAPIClient: NSObject, URLSessionTaskDelegate {
    static let shared = ResourceAPIClient()
    ...
    func createRequest(path: String, method: String = "GET") async -> URLRequest? {
        ...
        var url = config.api.resourceServerURL.appendingPathComponent(pathOnly)
